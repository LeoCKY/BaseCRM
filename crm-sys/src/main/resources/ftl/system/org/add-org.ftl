          ...
          <div class="layui-form-item">
              ...
              <div class="layui-form-item">
                  <label for="description" class="layui-form-label">
                      <span class="x-red"></span>敘述
                  </label>
                  <div class="layui-input-block">
                      <input type="text" id="description" style="width: 93%" name="description"  lay-verify="description"
                             autocomplete="off" class="layui-input">
                  </div>
              </div>
              ...
              <div class="layui-form-item">
                  <div class="layui-inline">
                      ...
                      <div class="layui-input-block" style="width:190px;">
                          <select name="type" id="orgType" lay-verify="orgType"  lay-filter="orgType">
                              <option value=""></option>
                              <option value="1">總公司</option>
                              <option value="2">分公司</option>
                              <option value="3">部門</option>
                          </select>
                      </div>
                  </div>
              </div>
              ...
              <div class="layui-form-item" id="pDiv">
                  ...
                  <div class="layui-input-inline">
                      ...
                      <input type="text" autocomplete="off" id="pName" onclick="showTree();"  lay-verify="pName" readonly
                             class="layui-input">
                  </div>
...
<script>
    layui.use(['form','layer'], function(){
        ...
        form.on('submit(add)', function(data){
            layerAjax('addOrg', data.field, 'orgList');
            return false;
        });
        form.render();
    });
