    ...
    <div style="width:100%;height:90%;overflow: auto;">
      ...
      <div class="layui-form-item">
        <label for="uname" class="layui-form-label">
          <span class="x-red">*</span>帳號
        </label>
        <div class="layui-input-inline">
          <input type="text"  id="uname" name="account"  lay-verify="username"
      ...
      <div class="layui-form-item">
        <div class="layui-inline">
          ...
          <div class="layui-input-inline">
            <input type="text" id="fName" name="fName" lay-verify="fName"  autocomplete="off" class="layui-input">
          </div>
        </div>
        ...
        <div class="layui-inline">
          ...
          <div class="layui-input-inline">
            <input type="text" id="lName" name="lName" lay-verify="lName"  autocomplete="off" class="layui-input">
          </div>
        </div>
      </div>
      ...
      <div class="layui-form-item">
        ...
        <div class="layui-inline">
          ...
          <div class="layui-input-inline">
            <input type="text" id="postcode" name="postcode" lay-verify="postcode"  autocomplete="off" class="layui-input">
          </div>
        </div>
      </div>
        ...
        $.ajax({
          url: 'checkUser?uname=' + uname, async: false, type: 'get', success: function (data) {
            ...
            if (!data.flag) {
              ...
              flag=true;
              $('#ms').append("<span style='color: green;'>用戶名可用</span>");
            }
          },beforeSend:function(){
            $('#ms').find('span').remove();
            $('#ms').append("<span>驗證ing</span>");
          }
        });
      }
    });
