                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block" style="width:190px;">
                        <select  disabled id="menuType" lay-verify="menuType"  lay-filter="menuType">
                            <option value=""></option>
                            <option <#if (sysMenu.PId)??==null>selected</#if> value="2">一級菜單</option>
                            <option <#if sysMenu.menuType='0'&&(sysMenu.PId)??>selected</#if> value="0">二級菜單</option>
                            <option <#if sysMenu.menuType=='1'>selected</#if> value="1">按鈕</option>
                        </select>
                    </div>
                </div>
                    ...
                    <div class="layui-input-inline">
                        <div style="margin-left: 20px;margin-top:5px">
                            <ul>
                                ...
                                <li style="display: inline-block;"><i class="layui-btn layui-btn-primary layui-btn-sm" id="select_icon">選擇圖標</i></li>
                            </ul>
                        </div>
                    </div>
                </div>
...
<script>
    layui.use(['form','layer'], function(){
        ...
        form.verify({
            ...
            ,orderNum: [/^[0-9]*[1-9][0-9]*$/, '請填寫序號(正整數)']
        });
